...
export function evolveThresholds(perfData, config) {
  ...
  // NOTE: was previously mis-keyed as "minFeeTvlRatio" (no-op); fixed to use
  // the actual config key config.screening.minFeeActiveTvlRatio.
  // The old "maxVolatility" section was also removed — that key does not exist
  // in config.js and is not used by any screening filter, making it a no-op.
  {
